...
public class program1_Tpdahp {
    ...
    private static double[][] oldPlate;// = new double[d + 2][d + 2];
    private static double[][] newPlate;// = new double[d + 2][d + 2];
    ...
    public static void diffuse(double[][] oldPlate, double[][] newPlate) {
