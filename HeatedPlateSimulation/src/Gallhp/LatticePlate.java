...
public class LatticePlate {
    ...
    public static double topEdgeTemp, bottomEdgeTemp, leftEdgeTemp, rightEdgeTemp;
        ...
        // Run the simulation
        public String runSimulation(int dim, double top, double bottom, double left,
        ...
        public String print(Lattice Plate) {
            String output = "";
            ...
            for(int i= 0; i < dimension; i++) {
                for(int j= 0; j < dimension; j++) {
                	...
                	output += String.format("%.2f", Plate.currentNode.temperature)+" ";
